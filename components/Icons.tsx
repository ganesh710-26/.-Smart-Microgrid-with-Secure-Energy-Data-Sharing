...
export const FingerPrintIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.588 8.26l-4.685-4.685a.75.75 0 011.06-1.06l4.685 4.685c.033-.16.062-.321.087-.484l-4.685-4.685a.75.75 0 011.06-1.06l4.685 4.685c.033-.16.062-.321.087-.484l-4.685-4.685a.75.75 0 011.06-1.06l4.685 4.685c.033-.16.062-.321.087-.484l-4.685-4.685a.75.75 0 011.06-1.06l4.685 4.685c.033-.16.062-.321.087-.484A7.5 7.5 0 017.864 4.243z" />
  </svg>
);
...
export const ArrowCounterClockwiseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
